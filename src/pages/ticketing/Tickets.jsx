  ...
  return (
    <div className="tickets min-h-screen bg-gray-100 flex flex-col items-center p-4">
      <header className="w-full max-w-4xl mb-8">
        ...
        {/* <img src="/img/facilities/robots04.webp" alt="" className="tickets-banner" style={{ width: '100%'}}/> */}
      </header>

      <main className="w-full max-w-4xl rounded-lg shadow-lg p-6">
        
        <div className='shoppingcart'>
          {/* Date Picker Section */}
        <section className="stat-card mb-6">
          ...
          />
            ...
            <section className="stat-card vmb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className='tickets_counter'>{tickets.adult}</span>
                    <button
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className='tickets_counter'>{tickets.child}</span>
                    <button
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className='tickets_counter'>{tickets.senior}</span>
                    <button
