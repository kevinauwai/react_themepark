...
const ProductDetail = () => {
  ...
  return (
    ...
    <div className='glass-card mt-5 product_container'>
      <div>
        <Button onClick={()=>history.back()} className='neural-btn m-4 bg-red-500  px-4 py-2 rounded hover:bg-red-600'>Back</Button>
      </div>
        <Row>
            <Col xs={12} lg={6}>
            ...
            <InputGroup className="mb-3 w-50">
                        <Button className='add-btn' data-img={product.img} variant="outline-secondary" onClick={(event)=>flyitemtocart(event,increase)} id="button-addon1">
                          +
                        </Button>
                        <Form.Control
