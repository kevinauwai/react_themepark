  ...
  return (
    ...
    <Card style={{ width: '100%' }} className='glass-card'>
                ...
                <Card.Body>
                    ...
                    <Button data-img={product.img}  className='add-btn neural-btn mt-4 bg-red-500  text-center  py-2 rounded hover:bg-red-600 text-decoration-none  w-100' onClick={(event)=>flyitemtocart(event,increase)}>Add to Cart</Button>
                     <Link to='/productDetail' state={{...product}} className='add-btn neural-btn mt-4 bg-red-500  text-center  py-2 rounded hover:bg-red-600 text-decoration-none  w-100'>Detail</Link>
